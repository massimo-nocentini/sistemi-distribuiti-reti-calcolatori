...
\draw[->,green,dashed,line width=1pt] (alfa1) to[bend right] (delta1);
\draw[->,green,dashed,line width=1pt](beta1) -- (delta1);     
\draw(2,-2) node[label] (l) {Figura 9.a: Ampliamento per $\alpha$, $\beta$ e $\gamma$.};
...
\draw[->,green,line width=1pt] (alfa2) to[bend right] (delta2);
\draw[->,green,line width=1pt](beta2) -- (delta2);     
\draw(9,-2) node[label] (l) {Figura 9.b: Ampliamento per $\delta$.};
