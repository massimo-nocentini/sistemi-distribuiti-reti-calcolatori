...
\begin{figure}[!h]
\centering
\input{img/concatenazioneSchedule.tex}\caption{Schedule disgiunti concatenati}\label{fig:concatenazioneSchedule}
\end{figure}
...
\begin{figure}[!h]
\centering
\input{img/parzialmenteCorretto.tex}\caption{Schedule parzialmente corretto}\label{fig:parzialmenteCorretto}
\end{figure}
